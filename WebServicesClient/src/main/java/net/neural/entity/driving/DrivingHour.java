...
@Entity(name="DrivingHour" )
@XmlRootElement(name="DrivingHour")
@XmlAccessorType(XmlAccessType.FIELD)
public class DrivingHour extends BaseEntity {
	...
	@XmlAttribute(name="startLocationLng")
	private Double startLocationLng;
	@XmlAttribute(name="startLocationLat")
	private Double startLocationLat;
	@XmlAttribute(name="endLocationLng")
	private Double endLocationLng;
	@XmlAttribute(name="endLocationLat")
