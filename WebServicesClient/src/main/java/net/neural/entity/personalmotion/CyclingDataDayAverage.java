...
@Entity(name="CyclingDataDayAverage" )
@XmlRootElement(name="CyclingDataDayAverage")
@XmlAccessorType(XmlAccessType.FIELD)
public class CyclingDataDayAverage extends BaseEntity {
